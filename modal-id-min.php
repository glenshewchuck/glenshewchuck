...
<a href='#' 
  ...
  data-iframe-src="https://dev.earlyiq.com/partner/realconnex/cert/getstarted?page_template=modal&first_name=John<?php echo $x; ?>
  &type=<?php echo $types; ?>
  &last_name=Smith
...
<script type='text/javascript' src='https://dev.earlyiq.com/sites/all/libraries/modal/js/earlyiq.min.js'></script>
